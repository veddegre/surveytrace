...
st_method('POST');
// CSRF is enforced inside st_method('POST'). Release the session lock before long Ollama/DB work so
// other tabs are not blocked on the session file (same idea as api/feeds.php long POST paths).
