...
<!-- Sidebar (Pass 2: grouped collapsible nav) -->
<div class="side" id="app-side">
  <div class="nav-grp" id="nav-grp-monitor" data-nav-group="monitor">
    <button type="button" class="nav-grp-hd" id="nav-grp-btn-monitor" onclick="stToggleNavGroup('monitor')" aria-expanded="true" aria-controls="nav-grp-body-monitor">
      <span class="nav-grp-hd-label">Monitor</span>
  ...
  <div class="nav-grp" id="nav-grp-operations" data-nav-group="operations">
    <button type="button" class="nav-grp-hd" id="nav-grp-btn-operations" onclick="stToggleNavGroup('operations')" aria-expanded="true" aria-controls="nav-grp-body-operations">
      <span class="nav-grp-hd-label">Operations</span>
      <span class="nav-grp-hd-chev" aria-hidden="true"></span>
    </button>
  ...
  <div class="nav-grp nav-grp--collapsed" id="nav-grp-organization" data-nav-group="organization">
    <button type="button" class="nav-grp-hd" id="nav-grp-btn-organization" onclick="stToggleNavGroup('organization')" aria-expanded="false" aria-controls="nav-grp-body-organization">
      <span class="nav-grp-hd-label">Organization</span>
      <span class="nav-grp-hd-chev" aria-hidden="true"></span>
    </button>
  ...
  <div class="nav-grp nav-grp--collapsed" id="nav-grp-administration" data-nav-group="administration">
    <button type="button" class="nav-grp-hd" id="nav-grp-btn-administration" onclick="stToggleNavGroup('administration')" aria-expanded="false" aria-controls="nav-grp-body-administration">
      <span class="nav-grp-hd-label">Administration</span>
      <span class="nav-grp-hd-chev" aria-hidden="true"></span>
    </button>
  ...
  <div class="nav-grp nav-grp--collapsed" id="nav-grp-activity" data-nav-group="activity">
    <button type="button" class="nav-grp-hd" id="nav-grp-btn-activity" onclick="stToggleNavGroup('activity')" aria-expanded="false" aria-controls="nav-grp-body-activity">
      <span class="nav-grp-hd-label">Activity</span>
      <span class="nav-grp-hd-chev" aria-hidden="true"></span>
    </button>
...
<div class="tab" id="t-dash">
  ...
  <div id="dash-exec">
    <section class="dash-workspace dash-workspace--exec st-dash-band st-dash-band--exec-brief" aria-labelledby="dash-exec-ws-title">
      ...
      <div class="exec-top-grid dash-exec-brief">
        <div class="dash-exec-brief-col">
          <div class="dash-inset-h">Overview</div>
          <div class="exec-brief-deltas" id="exec-brief-deltas"></div>
          <div class="exec-brief-list" id="exec-brief-list">Loading…</div>
        </div>
        <div class="dash-exec-brief-col dash-exec-brief-col--secondary">
          <div class="dash-inset-h">Recent changes</div>
    ...
    <section class="dash-workspace dash-workspace--charts st-dash-band st-dash-band--exec-charts" aria-labelledby="dash-exec-charts-title">
      ...
      <div class="dash-exec-charts-grid st-dash-exec-charts-grid">
        ...
        <div class="dash-chart-cell">
          <div class="dash-inset-h">Asset / coverage snapshot (14d)</div>
          <div id="exec-trend-assets" class="exec-chart"></div>
        </div>
        <div class="dash-chart-cell">
          <div class="dash-inset-h">Operational health (14d)</div>
          <div id="exec-trend-scans" class="exec-chart"></div>
        </div>
        <div class="dash-chart-cell">
          <div class="dash-inset-h">Issue severity mix</div>
...
<div class="tab" id="t-assets">
  ...
  <div id="af-filter-disclosures-row" class="row-wrap gap6 st-assets-disclosures-toolbar" style="align-items:center;flex-wrap:wrap" role="toolbar" aria-label="Asset list filters">
    ...
    <span id="af-zbx-filter-btn-wrap" style="display:none">
      <button type="button" id="af-zbx-disclosure-btn" class="tbtn btn-sm" aria-expanded="false" aria-controls="af-zbx-panel" onclick="stAssetsZbxDisclosureToggle()" title="Zabbix monitoring filters">Zabbix filters</button>
    </span>
    <span id="af-scope-filter-btn-wrap">
...
<div class="tab" id="t-sched">
  ...
  <div id="sched-bg" class="modal-bg z100">
    <div class="modal-card modal-w560 st-sched-modal">
      ...
      <div class="tr2"><div><div class="tl">Port &amp; banner probe</div><div class="tsubl">Safe TCP port list</div></div><label class="tog tog--sm tr2-check"><input type="checkbox" id="sched-ph-banner" checked aria-label="Include port and banner probe for scheduled runs"><div class="trk"></div><div class="tth"></div></label></div>
      <div class="tr2"><div><div class="tl">Service fingerprinting</div><div class="tsubl">OUI + banners → CPE</div></div><label class="tog tog--sm tr2-check"><input type="checkbox" id="sched-ph-fingerprint" checked aria-label="Include service fingerprinting for scheduled runs"><div class="trk"></div><div class="tth"></div></label></div>
...
<div id="host-rescan-bg" class="modal-bg z220" style="display:none" role="dialog" aria-labelledby="host-rescan-title">
  <div class="modal-card modal-w600" onclick="event.stopPropagation()">
    ...
    <p class="text-muted mb10" style="line-height:1.45">Choose profile and scan options for this host only. Changing the profile applies the same defaults as the <strong>Scan</strong> tab and schedules. Values load from the Scan tab when you open this dialog; edit here without leaving the host view.</p>
    ...
    <div id="host-rescan-scroll" class="mb10" style="max-height:min(52vh,520px);overflow-y:auto;padding-right:6px">
      <div class="ct mb4">Rate limiting</div>
      <div class="rr">
        <label class="flbl">Max packets/sec per host</label>
        <div class="rv"><span>1</span><span id="hr-pps-val">5 pps</span><span>50</span></div>
        <input class="rng" type="range" id="hr-pps" min="1" max="50" step="1" value="5" oninput="document.getElementById('hr-pps-val').textContent=this.value+' pps'">
      </div>
      <div class="rr">
        <label class="flbl">Inter-host delay</label>
        <div class="rv"><span>0</span><span id="hr-delay-val">200 ms</span><span>2000</span></div>
        <input class="rng" type="range" id="hr-delay" min="0" max="2000" step="10" value="200" oninput="document.getElementById('hr-delay-val').textContent=this.value+' ms'">
      </div>
      ...
      <div class="tr2"><div><div class="tl">Passive discovery</div><div class="tsubl">ARP watch, mDNS — zero packets sent</div></div><label class="tog tog--sm tr2-check"><input type="checkbox" id="hr-ph-passive" checked aria-label="Include passive discovery for this rescan"><div class="trk"></div><div class="tth"></div></label></div>
      <div class="tr2"><div><div class="tl">ICMP sweep</div><div class="tsubl">Ping / ARP sweep</div></div><label class="tog tog--sm tr2-check"><input type="checkbox" id="hr-ph-icmp" checked aria-label="Include ICMP sweep for this rescan"><div class="trk"></div><div class="tth"></div></label></div>
      <div class="tr2"><div><div class="tl">Port &amp; banner probe</div><div class="tsubl">TCP connect on safe port list</div></div><label class="tog tog--sm tr2-check"><input type="checkbox" id="hr-ph-banner" checked aria-label="Include port and banner probe for this rescan"><div class="trk"></div><div class="tth"></div></label></div>
      <div class="tr2"><div><div class="tl">Service fingerprinting</div><div class="tsubl">OUI + banner + port profile → CPE</div></div><label class="tog tog--sm tr2-check"><input type="checkbox" id="hr-ph-fingerprint" checked aria-label="Include service fingerprinting for this rescan"><div class="trk"></div><div class="tth"></div></label></div>
      <div class="tr2"><div><div class="tl">SNMP GET (read-only)</div><div class="tsubl">sysDescr, ifTable — no SET</div></div><label class="tog tog--sm tr2-check"><input type="checkbox" id="hr-ph-snmp" aria-label="Include SNMP read-only probes for this rescan"><div class="trk"></div><div class="tth"></div></label></div>
      <div class="tr2"><div><div class="tl">OT protocol probes</div><div class="tsubl warn-text">&#9888; Read-only probes</div></div><label class="tog tog--sm tr2-check"><input type="checkbox" id="hr-ph-ot" aria-label="Include OT protocol probes for this rescan"><div class="trk"></div><div class="tth"></div></label></div>
      <div class="tr2"><div><div class="tl">CVE correlation</div><div class="tsubl">Match CPE vs local NVD</div></div><label class="tog tog--sm tr2-check"><input type="checkbox" id="hr-ph-cve" checked aria-label="Include CVE correlation for this rescan"><div class="trk"></div><div class="tth"></div></label></div>
...
/** Set from GET /api/assets.php after each list load. */
window.__stAiNeedsReviewFilterAvailable = false;
window.__stAiSummaryFilterAvailable = false;
/** True when at least one AI list filter should be offered. */
window.__stAiFiltersToolbarAvailable = false;
var devicePage   = 1;
var vulnPage     = 1;
...
function applyRoleAwareUi() {
    ...
    disableByOnclick('saveAuthUserQuick(', !isAdmin);
    ...
    if (typeof currentTab === 'string') {
        ...
        const navId = navMapRestore[currentTab];
        if (navId) {
...
// Nav
// ==========================================================================
const ST_NAV_GROUP_KEYS = ['monitor', 'operations', 'organization', 'administration', 'activity'];
const ST_NAV_GROUP_STORAGE_KEY = 'st_nav_groups_v1';
const ST_NAV_GROUP_DEFAULTS = {
    monitor: true,
    operations: true,
    organization: false,
...
function stNavGroupsReadMap() {
    const o = { ...ST_NAV_GROUP_DEFAULTS };
    try {
        const raw = localStorage.getItem(ST_NAV_GROUP_STORAGE_KEY);
        if (!raw) return o;
        const parsed = JSON.parse(raw);
        if (parsed && typeof parsed === 'object') {
            ST_NAV_GROUP_KEYS.forEach((k) => {
                if (typeof parsed[k] === 'boolean') o[k] = parsed[k];
            });
        }
    } catch (e) {}
    return o;
...
function stNavGroupsWriteMap(map) {
    try {
        const out = {};
        ST_NAV_GROUP_KEYS.forEach((k) => { out[k] = !!map[k]; });
        localStorage.setItem(ST_NAV_GROUP_STORAGE_KEY, JSON.stringify(out));
    } catch (e) {}
}

function stNavGroupGetEl(key) {
    return document.querySelector('.nav-grp[data-nav-group="' + key + '"]');
}

function stNavGroupsApplyCollapseDom() {
    const map = stNavGroupsReadMap();
    ST_NAV_GROUP_KEYS.forEach((key) => {
        const grp = stNavGroupGetEl(key);
        if (!grp) return;
        if (grp.style.display === 'none') return;
        const open = !!map[key];
        grp.classList.toggle('nav-grp--collapsed', !open);
        const btn = grp.querySelector('.nav-grp-hd');
        if (btn) btn.setAttribute('aria-expanded', open ? 'true' : 'false');
    });
}

/** Hide groups with no visible nav rows (RBAC), then apply saved collapse state. */
function stNavSyncGroupsAfterRole() {
    document.querySelectorAll('.nav-grp').forEach((grp) => {
        const body = grp.querySelector('.nav-grp-body');
        if (!body) {
            grp.style.display = 'none';
            return;
        }
        let any = false;
        body.querySelectorAll('.ni').forEach((ni) => {
            if (ni.style.display !== 'none') any = true;
        });
...
function stNavGroupSetOpen(key, open) {
    if (!ST_NAV_GROUP_KEYS.includes(key)) return;
    const map = stNavGroupsReadMap();
    map[key] = !!open;
    stNavGroupsWriteMap(map);
    stNavGroupsApplyCollapseDom();
}

function stToggleNavGroup(key) {
    if (!ST_NAV_GROUP_KEYS.includes(key)) return;
    const grp = stNavGroupGetEl(key);
...
function hiNav(id) {
    ...
    if (grp) {
        ...
        if (key) stNavGroupSetOpen(key, true);
    }
}
...
function debounceAssetsZbxAware() {
    stAssetsUpdateZabbixDisclosureButtonLabel();
...
function stAssetsUpdateZabbixDisclosureButtonLabel() {
    const btn = document.getElementById('af-zbx-disclosure-btn');
    if (!btn || !window.__stAssetsZabbixFiltersAvailable) {
        return;
    }
    const n = stAssetsZabbixFilterActiveDims();
    btn.textContent = n ? ('Zabbix filters (' + String(n) + ' active)') : 'Zabbix filters';
}
...
function stAssetsAnyAiFilterActive() {
    const need = !!window.__stAiNeedsReviewFilterAvailable && !!document.getElementById('af-ai-review')?.checked;
    const sum = !!window.__stAiSummaryFilterAvailable && !!document.getElementById('af-ai-summary')?.checked;
    return need || sum;
}

function stAssetsAiFilterActiveCount() {
    let n = 0;
    if (window.__stAiNeedsReviewFilterAvailable && document.getElementById('af-ai-review')?.checked) {
        n += 1;
    }
...
function stAssetsUpdateAiFiltersButtonLabel() {
    const btn = document.getElementById('af-ai-filters-disclosure-btn');
    if (!btn || !window.__stAiFiltersToolbarAvailable) {
        return;
    }
    const n = stAssetsAiFilterActiveCount();
    btn.textContent = n ? ('AI filters (' + String(n) + ' active)') : 'AI filters';
}

function stAssetsOnAiFilterCheckboxChange() {
    stAssetsSyncAiFiltersDisclosureState();
    stAssetsUpdateAiFiltersButtonLabel();
    void loadAssets(1);
}
...
function stAssetsSyncAiFiltersDisclosureState() {
    ...
    const btn = document.getElementById('af-ai-filters-disclosure-btn');
    if (!panel || !btn || !window.__stAiFiltersToolbarAvailable) {
        return;
    }
    let open = stAssetsAnyAiFilterActive();
    if (!open) {
        try {
...
function stAssetsApplyAiFiltersFromServer(d) {
    const need = d && d.ai_needs_review_filter_available !== false;
    const sum = !!(d && d.ai_host_summary_filter_available);
    window.__stAiNeedsReviewFilterAvailable = need;
    window.__stAiSummaryFilterAvailable = sum;
    window.__stAiFiltersToolbarAvailable = need || sum;

    const btn = document.getElementById('af-ai-filters-disclosure-btn');
    const wrap = document.getElementById('af-ai-filters-wrap');
    const btnWrap = document.getElementById('af-ai-filter-btn-wrap');
    const rw = document.getElementById('af-ai-review-wrap');
    const sw = document.getElementById('af-ai-summary-wrap');
    if (btnWrap) {
        btnWrap.style.display = window.__stAiFiltersToolbarAvailable ? '' : 'none';
    }
    if (btn) {
        btn.style.display = '';
    }
    if (wrap) {
        wrap.style.display = window.__stAiFiltersToolbarAvailable ? '' : 'none';
    }
    if (rw) {
        rw.style.display = need ? 'inline-flex' : 'none';
    }
    if (sw) {
        sw.style.display = sum ? 'inline-flex' : 'none';
    }

    if (!need) {
        const ar = document.getElementById('af-ai-review');
        if (ar) {
            ar.checked = false;
        }
    }
    ...
    if (!window.__stAiFiltersToolbarAvailable) {
        const panel = document.getElementById('af-ai-filters-panel');
        if (panel) {
        ...
        try {
            localStorage.removeItem('st_assets_ai_filters_open');
        } catch (_e) {}
    } else {
        stAssetsSyncAiFiltersDisclosureState();
    }
...
function stAssetsApplyZabbixFromServer(avail) {
    ...
    const zbxBtnWrap = document.getElementById('af-zbx-filter-btn-wrap');
    if (zbxBtnWrap) {
        zbxBtnWrap.style.display = avail ? '' : 'none';
    }
    if (!avail) {
        const zm = document.getElementById('af-zbx-monitored');
...
function clearAllAssetFilters() {
    ...
    if (sev) sev.value = '';
    if (life) life.value = '';
    const scf = document.getElementById('af-scope-filter');
    if (scf) scf.value = '';
    if (srt) srt.value = 'ip';
    ...
    const aip = document.getElementById('af-ai-filters-panel');
    const aib = document.getElementById('af-ai-filters-disclosure-btn');
    if (aip) {
        aip.classList.add('hide');
    }
    if (aib) {
        aib.setAttribute('aria-expanded', 'false');
    }
    stAssetsUpdateAiFiltersButtonLabel();
    if (zm) zm.value = '';
    if (zu) zu.checked = false;
    ...
    const spp = document.getElementById('af-scope-panel');
    const sbtn = document.getElementById('af-scope-disclosure-btn');
    if (spp) {
        spp.classList.add('hide');
    }
    if (sbtn) {
        sbtn.setAttribute('aria-expanded', 'false');
    }
    try {
        localStorage.removeItem('st_assets_scope_filters_open');
    } catch (_e) {}
    stAssetsUpdateZabbixDisclosureButtonLabel();
...
function stAssetsZabbixFilterSummaryLabel() {
    const bits = [];
    const zm = document.getElementById('af-zbx-monitored')?.value || '';
    if (zm === '1') {
        bits.push('monitored');
    } else if (zm === '0') {
        bits.push('not monitored');
    }
    if (document.getElementById('af-zbx-unavail')?.checked) {
    ...
    return 'Zabbix (' + bits.join(', ') + ')';
}

function stAssetsScopeFilterActiveCount() {
    const sel = document.getElementById('af-scope-filter');
    if (!window.__stAssetsScopeColumn || !sel || sel.style.display === 'none') {
        return 0;
    }
    return sel.value !== '' ? 1 : 0;
}

function stAssetsUpdateScopeDisclosureButtonLabel() {
    const btn = document.getElementById('af-scope-disclosure-btn');
    if (!btn) {
        return;
    }
    if (btn.disabled) {
        btn.textContent = 'Scope filters (unavailable)';
        return;
    }
    const n = stAssetsScopeFilterActiveCount();
    btn.textContent = n ? ('Scope filters (' + String(n) + ' active)') : 'Scope filters';
}

function stAssetsSyncScopeDisclosureState() {
    const panel = document.getElementById('af-scope-panel');
    const btn = document.getElementById('af-scope-disclosure-btn');
    if (!panel || !btn || btn.disabled) {
        return;
    }
    const sel = document.getElementById('af-scope-filter');
    let open = !!(sel && sel.style.display !== 'none' && sel.value !== '');
    if (!open) {
        try {
            open = localStorage.getItem('st_assets_scope_filters_open') === '1';
        } catch (_e) {
            open = false;
        }
    }
...
function stAssetsScopeDisclosureToggle() {
    const panel = document.getElementById('af-scope-panel');
    const btn = document.getElementById('af-scope-disclosure-btn');
    if (!panel || !btn || btn.disabled) {
        return;
    ...
    btn.setAttribute('aria-expanded', willOpen ? 'true' : 'false');
    try {
        localStorage.setItem('st_assets_scope_filters_open', willOpen ? '1' : '0');
    } catch (_e) {}
    stAssetsUpdateScopeDisclosureButtonLabel();
}

function stAssetsOnScopeFilterChange() {
    stAssetsUpdateScopeDisclosureButtonLabel();
    stAssetsSyncScopeDisclosureState();
    void loadAssets(1);
}

function stAssetsExpandFilterPanel(which, doScroll) {
    if (which === 'ai') {
        if (!window.__stAiFiltersToolbarAvailable) {
            return;
        }
        ...
        btn.setAttribute('aria-expanded', 'true');
        try {
            localStorage.setItem('st_assets_ai_filters_open', '1');
        } catch (_e) {}
        stAssetsUpdateAiFiltersButtonLabel();
        if (doScroll && wrap) {
    ...
    if (which === 'zbx') {
        ...
        btn.setAttribute('aria-expanded', 'true');
        try {
            localStorage.setItem('st_assets_zbx_filters_open', '1');
        } catch (_e) {}
        stAssetsUpdateZabbixDisclosureButtonLabel();
        if (doScroll && sec) {
    ...
    if (which === 'scope') {
        const btn = document.getElementById('af-scope-disclosure-btn');
        const panel = document.getElementById('af-scope-panel');
        if (!btn || btn.disabled || !panel) {
            return;
        }
        panel.classList.remove('hide');
        btn.setAttribute('aria-expanded', 'true');
        try {
            localStorage.setItem('st_assets_scope_filters_open', '1');
        } catch (_e) {}
        stAssetsUpdateScopeDisclosureButtonLabel();
        if (doScroll) {
            document.getElementById('af-scope-section')?.scrollIntoView({ block: 'nearest', behavior: 'smooth' });
        }
    }
}

function stAssetsSummarySegmentClick(which) {
    const w = String(which || '');
    if (w !== 'ai' && w !== 'zbx' && w !== 'scope') {
        return;
    }
    stAssetsExpandFilterPanel(w, true);
}

function stAssetsRenderFilterSummary() {
    const bar = document.getElementById('af-filter-summary-bar');
    if (!bar) {
        return;
    }
    const parts = [];
    const sf = document.getElementById('af-scope-filter');
    const scopeOn = window.__stAssetsScopeColumn && sf && sf.style.display !== 'none' && sf.value !== '';
    if (scopeOn) {
        const opt = sf.options[sf.selectedIndex];
        const raw = opt ? String(opt.textContent || '').trim() : '';
        const nameOnly = raw.replace(/\s*\([^)]*\)\s*$/, '').trim() || raw || 'Scope';
        parts.push({ key: 'scope', label: 'Scope=' + nameOnly.slice(0, 48) });
    }
    if (window.__stAiNeedsReviewFilterAvailable && document.getElementById('af-ai-review')?.checked) {
        parts.push({ key: 'ai', label: 'Needs AI review' });
    }
    if (window.__stAiSummaryFilterAvailable && document.getElementById('af-ai-summary')?.checked) {
        parts.push({ key: 'ai', label: 'Has host summary' });
    }
    if (window.__stAssetsZabbixFiltersAvailable && stAssetsZabbixFilterActiveDims() > 0) {
        parts.push({ key: 'zbx', label: stAssetsZabbixFilterSummaryLabel() });
    }
    let html = '<span class="af-sum-lbl">Showing:</span> ';
    if (assetDeviceFilter > 0) {
        html += '<span class="af-sum-seg af-sum-seg--dim">Device #' + esc(String(assetDeviceFilter)) + '</span>';
    }
    if (!parts.length) {
        if (assetDeviceFilter > 0) {
            html += ' <span class="text-dim">·</span> <span class="text-dim">no extra list filters</span>';
        } else {
            html += '<span class="text-dim">no extra list filters</span>';
        }
    } else {
        if (assetDeviceFilter > 0) {
        ...
        for (let i = 0; i < parts.length; i++) {
            ...
            const p = parts[i];
            const segKey = p.key === 'scope' || p.key === 'zbx' || p.key === 'ai' ? p.key : 'ai';
            html += '<button type="button" class="af-sum-seg" onclick="stAssetsSummarySegmentClick(\'' + segKey + '\')">' + esc(p.label) + '</button>';
        }
    }
    bar.innerHTML = html;
}

function stAssetsFillScopeFilter(d) {
    const sel = document.getElementById('af-scope-filter');
    const hint = document.getElementById('af-scope-unavailable-hint');
    const btn = document.getElementById('af-scope-disclosure-btn');
    if (!sel) {
        return;
    }
    if (!d || !d.assets_scope_column || !Array.isArray(d.asset_scope_filter_options)) {
        ...
        if (btn) {
            ...
            btn.title = 'Inventory scope filter requires the assets.scope_id column and scope catalog (migrations / Scopes tab).';
        }
        const panel = document.getElementById('af-scope-panel');
        if (panel) {
            panel.classList.add('hide');
    ...
    if (btn) {
        ...
        btn.title = 'Filter by inventory scope (assets.scope_id). Distinct from Reports job scope.';
    }
    const prev = sel.value;
    sel.innerHTML = '<option value="">All scopes</option>';
    const un = d.unscoped_asset_count != null ? Number(d.unscoped_asset_count) : 0;
    const o0 = document.createElement('option');
    o0.value = '0';
    o0.textContent = 'Unscoped (' + String(un) + ')';
    sel.appendChild(o0);
    (d.asset_scope_filter_options || []).forEach((s) => {
        const id = parseInt(String(s.id || '0'), 10);
        if (!id) {
            return;
        }
        const op = document.createElement('option');
        op.value = String(id);
        const nm = String(s.name || 'Scope #' + id).slice(0, 80);
        const c = s.asset_count != null ? Number(s.asset_count) : 0;
        op.textContent = nm + ' (' + String(c) + ')';
        sel.appendChild(op);
    });
    const ok = new Set(['', '0']);
    (d.asset_scope_filter_options || []).forEach((s) => {
...
async function loadAssets(page) {
    ...
    const aiReview = !!window.__stAiNeedsReviewFilterAvailable && !!document.getElementById('af-ai-review')?.checked;
    ...
    stAssetsApplyAiFiltersFromServer(d);

    try {
        window.__stAssetsScopeColumn = !!d.assets_scope_column;
    } catch (_e) {}
    stAssetsFillScopeFilter(d);
...
function applyHostRescanModalRateSlidersForProfile(profile) {
    ...
    const ppsEl = document.getElementById('hr-pps');
    const delEl = document.getElementById('hr-delay');
    const ppsVal = document.getElementById('hr-pps-val');
    const delVal = document.getElementById('hr-delay-val');
...
function syncHostRescanModalScanStepBannerOpacity() {
    ['hr-ph-banner', 'hr-ph-fingerprint', 'hr-ph-cve'].forEach(id => {
        ...
        if (tr) tr.style.opacity = el.checked ? '1' : '0.4';
    });
}

function readScanTabIntoHostRescanModal() {
    ['passive', 'icmp', 'banner', 'fingerprint', 'snmp', 'ot', 'cve'].forEach(p => {
        const src = document.getElementById('ph-' + p);
        const dst = document.getElementById('hr-ph-' + p);
        if (src && dst) dst.checked = src.checked;
    });
    const pps = document.getElementById('sc-pps');
    const del = document.getElementById('sc-delay');
    const hpps = document.getElementById('hr-pps');
    const hdel = document.getElementById('hr-delay');
    const hppsV = document.getElementById('hr-pps-val');
    const hdelV = document.getElementById('hr-delay-val');
    if (pps && hpps) {
        hpps.value = pps.value;
        if (hppsV) hppsV.textContent = hpps.value + ' pps';
    }
    if (del && hdel) {
        hdel.value = del.value;
        if (hdelV) hdelV.textContent = hdel.value + ' ms';
    }
    const mode = document.querySelector('input[name="scan_mode"]:checked');
    const v = mode ? mode.value : 'auto';
    const rid = v === 'routed' ? 'hr-sm-routed' : v === 'force' ? 'hr-sm-force' : 'hr-sm-auto';
    const m = document.getElementById(rid);
    if (m) m.checked = true;
...
function syncHostRescanEnrichmentFromScanTab() {
    const scanWrap = document.getElementById('scan-enrichment-wrap');
    const hrWrap = document.getElementById('host-rescan-enrichment-wrap');
    if (!scanWrap || scanWrap.dataset.ready !== '1' || !hrWrap || hrWrap.dataset.ready !== '1') return;
    hrWrap.querySelectorAll('input[data-enr-id]:not(:disabled)').forEach(hCb => {
        const id = hCb.dataset.enrId;
        const sCb = scanWrap.querySelector('input[data-enr-id="' + id + '"]');
        if (sCb && !sCb.disabled) hCb.checked = sCb.checked;
    });
}

/** Same preset rules as applyScanTabProfileDefaults, for host-rescan modal controls (hr-*). */
function applyHostRescanModalProfileDefaults(profile) {
    ...
    const passive = document.getElementById('hr-ph-passive');
    const icmp = document.getElementById('hr-ph-icmp');
    ...
    applyHostRescanModalRateSlidersForProfile(profile);

    const smForce = document.getElementById('hr-sm-force');
    const smAuto = document.getElementById('hr-sm-auto');
...
function updateHostRescanHint() {
    ...
    updateHostRescanProfileWarn(sel.value);
}
    ...
    return new Promise((resolve) => {
        ...
        void (async () => {
            try {
                ...
                toast('Could not open rescan dialog', 'err');
                resolve(null);
            }
        })();
    });
...
function wireHostRescanModalOnce() {
    ...
    document.getElementById('host-rescan-profile')?.addEventListener('change', function() {
        applyHostRescanModalProfileDefaults(this.value);
    });
    ...
    document.getElementById('host-rescan-queue-btn')?.addEventListener('click', () => {
        ...
        const phases = [];
        ['passive', 'icmp', 'banner', 'fingerprint', 'snmp', 'ot', 'cve'].forEach(p => {
            if (document.getElementById('hr-ph-' + p)?.checked) phases.push(p);
        });
        if (!phases.length) {
            ['passive', 'icmp', 'banner', 'fingerprint', 'cve'].forEach(p => phases.push(p));
        }
        const modeEl = document.querySelector('input[name="hr_scan_mode"]:checked');
...
async function queueHostRescan(ip, triggerBtn) {
    ...
    let phases = Array.isArray(choice.phases) && choice.phases.length
        ? choice.phases.slice()
        : [];
    if (!phases.length) {
        ['passive', 'icmp', 'banner', 'fingerprint', 'cve'].forEach(p => phases.push(p));
    }
    const rate_pps = Math.max(1, Math.min(50, parseInt(String(choice.rate_pps ?? '5'), 10) || 5));
    const inter_delay = Math.max(0, Math.min(2000, parseInt(String(choice.inter_delay ?? '200'), 10) || 200));
    const scanModeEff = clampRescanScanModeForProfile(profileVal, choice.scan_mode || 'auto');
    ...
    const body = {
        cidr: targetCidr,
        exclusions: choice.exclusions !== undefined
            ? choice.exclusions
            : (document.getElementById('sc-excl') ? document.getElementById('sc-excl').value : ''),
        phases,
        rate_pps,
        inter_delay,
        label: hostLabel,
        scan_mode: scanModeEff,
        profile: profileVal,
        confirmed: true,
    };
...
/** Host-rescan modal enrichment; same semantics as scanEnrichmentPayloadField(). */
function hostEnrichmentPayloadField() {
    const wrap = document.getElementById('host-rescan-enrichment-wrap');
    if (!wrap || wrap.dataset.ready !== '1') return undefined;
    const enabledBoxes = wrap.querySelectorAll('input[data-enr-id]:not(:disabled)');
    if (!enabledBoxes.length) return undefined;
    const checked = [];
    enabledBoxes.forEach(cb => { if (cb.checked) checked.push(parseInt(cb.dataset.enrId, 10)); });
    if (checked.length === enabledBoxes.length) return undefined;
...
/** @param {string} [wrapId] Default scan-enrichment-wrap; use host-rescan-enrichment-wrap for rescan modal */
async function refreshScanEnrichmentPicker(wrapId) {
    const wrap = document.getElementById(wrapId || 'scan-enrichment-wrap');
    if (!wrap) return;
...
function hpAiEnvelopeBody(env) {
    if (!env || typeof env !== 'object') return '<div class="hp-empty st-host-empty">No AI summary yet. Generate one when you want a quick narrative (verify against findings and ports).</div>';
    const st = String(env.status || '');
    const det = env.detail != null ? String(env.detail) : '';
    if (st === 'failed' || st === 'skipped') {
        return `<div class="hp-empty st-host-empty">${
            st === 'failed' ? 'Generation failed' : 'Skipped'
        }${det ? ` — ${esc(det)}` : ''}</div>`;
    }
    const doc = env.doc && typeof env.doc === 'object' ? env.doc : null;
    if (!doc) return '<div class="hp-empty st-host-empty">Summary payload empty — try regenerating.</div>';
    return '';
}
...
function hpAiExplainDocHtml(doc) {
    ...
    const qs = Array.isArray(doc.owner_questions) && doc.owner_questions.length
        ...
        : '';
    if (!ov && !roles && !tips && !qs) return '<div class="hp-empty st-host-empty">Model returned an empty structure — regenerate or rely on raw inventory above.</div>';
...
/** Open high + critical counts from one trends_summary row (snapshot), or null if row invalid. */
function reportingTrendsOpenHighCritical(row) {
    if (!row || typeof row !== 'object') {
        return null;
    }
    const by =
        row.open_findings_by_severity && typeof row.open_findings_by_severity === 'object'
            ? row.open_findings_by_severity
            : {};
    const c = parseInt(String(by.critical != null ? by.critical : 0), 10);
    const h = parseInt(String(by.high != null ? by.high : 0), 10);
    const cc = Number.isFinite(c) ? c : 0;
    const hh = Number.isFinite(h) ? h : 0;
    return cc + hh;
}

function reportingTrendsRowByJobId(ts, jobId) {
    if (!Array.isArray(ts)) {
        return null;
    }
    const want = parseInt(String(jobId), 10);
    for (let i = 0; i < ts.length; i++) {
        const j = parseInt(String(ts[i].job_id), 10);
        if (j === want) {
            return ts[i];
        }
    }
...
/**
 * @returns {{ html: string, badgeKey: string, badgeLabel: string, badgeEmoji: string }}
 */
function reportingCompareRiskClassification(nc, deltaHc, hasTrendPair) {
    const sig = reportingCompareIsSignificant(nc);
    const dh = deltaHc == null || !Number.isFinite(deltaHc) ? 0 : deltaHc;
    const highHc = hasTrendPair && dh > 0;
    const newRows = nc.new_findings_rows > 0;
    const reopened = nc.reopened_in_b > 0;
    if (highHc) {
        return {
            html:
                '<span class="report-risk-badge report-risk-high" title="Open high or critical findings increased between these two completed scans">🔴 HIGH RISK</span>',
            badgeKey: 'high',
            badgeLabel: 'HIGH RISK',
            badgeEmoji: '🔴',
        };
    }
    if (reopened || (newRows && !hasTrendPair)) {
        return {
            html:
                '<span class="report-risk-badge report-risk-warn" title="Reopened findings or new finding rows in the current snapshot">🟠 WARNING</span>',
            badgeKey: 'warn',
            badgeLabel: 'WARNING',
            badgeEmoji: '🟠',
        };
    }
    if (newRows && hasTrendPair) {
        return {
            html:
                '<span class="report-risk-badge report-risk-warn" title="New finding rows in current snapshot — review severities in Vulnerabilities">🟠 WARNING</span>',
            badgeKey: 'warn',
            badgeLabel: 'WARNING',
            badgeEmoji: '🟠',
        };
    ...
    if (
        ...
        return {
            html:
                '<span class="report-risk-badge report-risk-ok" title="Findings moved to resolved with no new or reopened rows in this diff">🟢 IMPROVED</span>',
            badgeKey: 'improved',
            badgeLabel: 'IMPROVED',
            badgeEmoji: '🟢',
        };
    ...
    if (!sig) {
        return {
            html:
                '<span class="report-risk-badge report-risk-stable" title="No material deltas in snapshot counters for this pair">⚪ STABLE</span>',
            badgeKey: 'stable',
            badgeLabel: 'STABLE',
            badgeEmoji: '⚪',
        };
    ...
    return {
        html:
            '<span class="report-risk-badge report-risk-warn" title="Inventory or port changes — review callouts below">🟠 WARNING</span>',
        badgeKey: 'warn',
        badgeLabel: 'WARNING',
        badgeEmoji: '🟠',
    };
...
function reportingCompareAttentionCalloutsHtml(nc, deltaHc, hasTrendPair) {
    const items = [];
    const dh = deltaHc == null || !Number.isFinite(deltaHc) ? 0 : deltaHc;
    if (nc.assets_only_in_a > 0) {
        const n = nc.assets_only_in_a;
        items.push(
            '<li><strong>Hosts removed</strong> — ' +
                esc(String(n)) +
                ' ' +
                (n === 1 ? 'host is' : 'hosts are') +
                ' no longer detected in the current scan — verify whether that is expected (scope, coverage, or retirement).</li>'
        );
    }
    if (nc.assets_only_in_b > 0) {
        const n = nc.assets_only_in_b;
        items.push(
            '<li><strong>New assets</strong> — ' +
                esc(String(n)) +
                ' new ' +
                (n === 1 ? 'asset was' : 'assets were') +
                ' detected in the current scan.</li>'
        );
    }
    if (nc.reopened_in_b > 0) {
        items.push(
            '<li><strong>Reopened findings</strong> — previously resolved issues have reappeared in the current snapshot.</li>'
        );
    }
    if (hasTrendPair && dh > 0) {
        items.push(
            '<li><strong>New high-risk vulnerabilities detected</strong> — open high or critical findings increased by ' +
                esc(String(dh)) +
                ' between these two completed scans.</li>'
        );
    } else if (nc.new_findings_rows > 0 && !(hasTrendPair && dh > 0)) {
        items.push(
            '<li><strong>New findings</strong> — new open finding rows appeared in the current snapshot; review severity in <strong>Vulnerabilities</strong>.</li>'
        );
    }
    if (!items.length) {
        return '';
    ...
    return (
        '<ul class="hint-micro report-snapshot-callouts" style="margin:8px 0 0;padding-left:18px;line-height:1.5">' +
        items.join('') +
        '</ul>'
    );
}
...
function reportingCompareNarrativeParagraph(refId, curId, nc, deltaHc, hasTrendPair, narrativeOpts) {
    ...
    const parts = [];
    parts.push(
        'Compared to <strong>reference scan #' +
            esc(String(r)) +
    ...
    if (!sig) {
        parts.push(' shows <strong>no material change</strong> in snapshot counters (assets, findings, and port deltas).');
        return '<p class="hint-micro report-snapshot-narrative" style="line-height:1.55;margin:0 0 8px">' + parts.join('') + '</p>';
    }
    let tone = 'shows a <strong>mixed picture</strong>';
    const bad =
        nc.reopened_in_b > 0 ||
        nc.new_findings_rows > 0 ||
        (hasTrendPair && dh > 0) ||
        nc.assets_only_in_a > 0 ||
        nc.assets_only_in_b > 0;
    const good = nc.marked_resolved_in_b > 0 || (hasTrendPair && dh < 0);
    if (good && !bad) {
        tone = 'shows <strong>a slight improvement</strong>';
    } else if (bad && !good) {
        tone = 'shows <strong>increased exposure or drift</strong>';
    } else if (good && bad) {
        tone = 'shows <strong>a mixed picture</strong>';
    } else {
        tone = 'shows <strong>measurable drift</strong>';
    }
    parts.push(' ' + tone + '.');
    const detail = [];
    ...
    if (nc.new_findings_rows === 0 && nc.reopened_in_b === 0 && !(hasTrendPair && dh > 0)) {
        tail.push('No new or reopened risks were flagged in this snapshot diff.');
    }
    if (tail.length) {
...
function reportingCompareSummaryCardsHtml(nc, cardOpts) {
    ...
    h += card('New findings', String(nc.new_findings_rows), 'New open rows in current snapshot', newFindTone);
...
function reportingHumanizeFindingEventKey(k) {
    const m = {
        marked_resolved_in_b: 'Findings resolved in current scan',
        reopened_in_b: 'Findings reopened',
        open_in_a_absent_in_b_snapshots: 'Open in reference, absent in current snapshot',
    };
    return m[k] || reportingHumanizeRuleKey(k);
}
...
function reportingRenderCompareAdvancedDetails(counts, finding_events) {
    ...
    push('Assets in reference scan', num(c.assets_a));
    push('Assets in current scan', num(c.assets_b));
    push('Assets missing from current scan', num(c.assets_only_in_a) || num(c.removed_hosts));
    push('New assets in current scan', num(c.assets_only_in_b) || num(c.new_hosts));
    push('Hosts with port changes', num(c.hosts_with_port_delta));
    push('New finding rows in current scan', num(c.new_findings_rows) || num(c.findings_only_in_b));
    push('Finding rows only in reference snapshot', num(c.findings_absent_in_b) || num(c.findings_only_in_a));
    push('Findings resolved in current scan', num(fe.marked_resolved_in_b) || num(c.marked_resolved_in_b));
    push('Findings reopened', num(fe.reopened_in_b) || num(c.reopened_in_b));
    push(
        'Previously open findings not seen in current snapshot',
        num(fe.open_in_a_absent_in_b_snapshots) || num(c.open_in_a_absent_in_b)
    );
    push('Resolution changes (total rows)', num(c.resolution_changes));
    const shown = new Set([
        'assets_a',
        'assets_b',
        'assets_only_in_a',
    ...
    Object.keys(c)
        ...
        .forEach((k) => {
            ...
            extra.push('<tr><td class="mono-sm">' + esc(k) + '</td><td>' + esc(String(c[k])) + '</td></tr>');
        });
    let feRows = '';
    Object.keys(fe)
        .sort()
        .forEach((k) => {
            feRows +=
                '<tr><td>' +
                esc(reportingHumanizeFindingEventKey(k)) +
                '</td><td>' +
                esc(String(fe[k])) +
                '</td></tr>';
        });
    ...
    if (extra.length) {
        extraBlock =
            '<div class="hint-micro text-dim mt8 mb4">Additional server counters (internal keys)</div><table class="tbl"><tbody>' +
            extra.join('') +
            '</tbody></table>';
    }
    let h =
...
function reportingRenderCompareExecutiveSummary(s, opts) {
    ...
    const warns =
        warnList.length > 0
            ? '<div class="hint-micro mt8 hstate-warn">' +
              ...
              '</div>'
            : '';
    let deltaHc = opts.trendDeltaHc;
    if (deltaHc == null || !Number.isFinite(deltaHc)) {
        deltaHc = 0;
    }
    ...
    const adv =
        '<details class="mt10 report-snapshot-advanced" style="border:1px solid var(--border);border-radius:6px;padding:8px 10px">' +
        '<summary class="hint-micro" style="cursor:pointer;font-weight:600">Advanced details</summary>' +
        '<div class="hint-micro text-dim mt6 mb6">Counter table for this scan pair (technical). Expanded fields use server-internal keys for support/debug.</div>' +
        reportingRenderCompareAdvancedDetails(s.counts, s.finding_events) +
        '</details>';
    return head + narrative + badgeRow + callouts + cards + warns + adv;
}
...
/** Best-effort critical count from compliance rule detail (no new API). */
function reportingComplianceExtractCriticalCount(rules) {
    const r = rules && typeof rules === 'object' ? rules.no_critical_open : null;
    if (!r || r.pass || !r.detail) {
        return null;
    }
...
function reportingComplianceFriendlySummaryLine(c) {
    const pass = !!(c && c.overall_pass);
    const rules = c && c.rules && typeof c.rules === 'object' ? c.rules : {};
    if (pass) {
        return 'No critical or baseline regressions detected.';
    }
    const critN = reportingComplianceExtractCriticalCount(rules);
    if (critN != null && critN > 0) {
        return 'Critical vulnerabilities are still present (' + critN + ' detected).';
    }
    return 'One or more policy checks failed on this completed scan.';
}
...
function reportingRenderComplianceArtifactCard(cs) {
    ...
    h += '</tbody></table>';
    h +=
        '<div class="hint-micro mt6">Stored artifacts only keep pass/fail and ids. Use <strong>Compliance detail</strong> (Reports &amp; Analysis → Analysis &amp; tools) with the same job for full rule text.</div>';
    h += '</div>';
    return h;
}
...
function reportingRenderComplianceFull(c) {
    ...
    const badge = pass
        ? '<span style="color:var(--green);font-weight:600">PASS</span>'
        : '<span style="color:var(--amber);font-weight:600">FAIL</span>';
    const friendly = reportingComplianceFriendlySummaryLine(c);
    let h =
        '<div class="card mb10" style="padding:12px 14px;border:1px solid var(--border)">' +
        '<div class="hint-micro" style="font-size:14px;line-height:1.45;margin:0 0 8px">' +
        esc(friendly) +
        '</div>' +
        '<div style="display:flex;align-items:center;gap:10px;flex-wrap:wrap"><span class="text-secondary">Overall</span>' +
        badge +
        '</div></div>';
    h += '<div class="sth mb6" style="font-size:12px">Evaluation context</div>';
    h += '<table class="tbl mb10"><tbody>';
    h += '<tr><td>Scan evaluated</td><td class="mono-sm">' + esc(String(c.job_id != null ? c.job_id : '—')) + '</td></tr>';
    const beff = c.baseline_job_id != null ? c.baseline_job_id : c.baseline_effective;
    h +=
        '<tr><td>Baseline used for rules</td><td class="mono-sm">' +
        esc(String(beff != null && beff !== '' ? beff : '—')) +
        '</td></tr>';
    const bcfg = c.baseline_config_job_id != null ? c.baseline_config_job_id : c.baseline_config_id;
    h +=
        '<tr><td>Configured baseline id</td><td class="mono-sm">' +
...
async function loadReportingAtGlance() {
    ...
    const line = c && typeof c === 'object' ? reportingComplianceFriendlySummaryLine(c) : '';
    cmpEl.innerHTML =
        '<div><strong>Compliance (snapshot) — latest completed scan #' +
        esc(String(jid)) +
        '</strong> <span class="text-dim">(vs baseline rules)</span></div>' +
        '<div class="hint-micro mt6" style="line-height:1.45">' +
        esc(line) +
        ' <span class="text-dim">' +
        badge +
        ' — full rule text under <strong>Compliance detail</strong>.</span></div>';
}
...
async function loadReportingChangeSince() {
    ...
    const hint =
        ...
        esc(hintText) +
        '</div>';
    const refRow = reportingTrendsRowByJobId(ts, jobA);
    const curRow = ts[0];
    let trendDeltaHc = 0;
    let trendHasPair = false;
    if (refRow && curRow) {
        const hr = reportingTrendsOpenHighCritical(refRow);
        const hc = reportingTrendsOpenHighCritical(curRow);
        if (hr !== null && hc !== null) {
            trendDeltaHc = hc - hr;
            trendHasPair = true;
        }
...
/** Simple SVG line chart for snapshot trends (oldest → newest, left to right). */
function reportingTrendSnapshotLineChart(values, title, colorCss) {
    const n = values.length;
    if (n < 2) {
        return (
            '<div class="mb10"><div class="hint-micro mb4" style="font-weight:600">' +
            esc(title) +
            '</div><span class="text-dim">Not enough points</span></div>'
        );
    }
    const W = 340;
    const H = 118;
    ...
    for (let i = 0; i < n; i++) {
        ...
        const y = padT + (1 - (values[i] - minV) / (maxV - minV)) * ih;
        pts.push(x.toFixed(1) + ',' + y.toFixed(1));
    }
    const stroke = colorCss || 'currentColor';
    const yMax = padT + ih;
    return (
        '<div class="mb12" style="max-width:100%">' +
        '<div class="hint-micro mb4" style="font-weight:600">' +
        esc(title) +
        '</div>' +
        '<svg width="' +
        W +
        ...
        ' ' +
        H +
        '" xmlns="http://www.w3.org/2000/svg" class="report-trend-line-chart" role="img" aria-label="' +
        esc(title) +
        '">' +
        '<line x1="' +
        padL +
        ...
        '" y="' +
        (H - 6) +
        '" font-size="10" fill="currentColor" opacity="0.55">Older</text>' +
        '<text x="' +
        (W - padR - 40) +
        '" y="' +
        (H - 6) +
        '" font-size="10" fill="currentColor" opacity="0.55">Newer</text>' +
        '<text x="' +
        (padL + 2) +
        '" y="' +
        (padT + 10) +
        ...
        '" y="' +
        yMax +
        '" font-size="10" fill="currentColor" opacity="0.55" dominant-baseline="ideographic">' +
        esc(String(minV)) +
        '</text>' +
...
function reportingRenderTrendsSummaryHtml(chrono) {
    ...
    h +=
        '<div class="hint-micro text-dim mb10"><strong>Snapshot-based trend (not real-time)</strong> — up to 50 most recent finished jobs, oldest on the left.</div>';
    ...
    const hcVals = chrono.map((r) => {
        const by =
            r.open_findings_by_severity && typeof r.open_findings_by_severity === 'object'
                ? r.open_findings_by_severity
                : {};
        const c = parseInt(String(by.critical != null ? by.critical : 0), 10) || 0;
        const hi = parseInt(String(by.high != null ? by.high : 0), 10) || 0;
        return c + hi;
    });
    h += '<div class="row-wrap gap10 mb10" style="align-items:flex-start">';
    h += reportingTrendSnapshotLineChart(assetVals, 'Asset count over time', 'var(--blue)');
    h += reportingTrendSnapshotLineChart(findVals, 'Open findings over time', 'var(--amber)');
    h += reportingTrendSnapshotLineChart(hcVals, 'High + critical (open) over time', 'var(--red)');
    h += '</div>';

    h +=
        '<div class="sth" style="font-size:12px;margin-bottom:6px">Assets over time <span class="text-dim">(oldest → newest)</span></div>';
    h += '<div class="tbl-wrap mb12"><table class="tbl"><thead><tr><th>Finished</th><th>Scan #</th><th>Label</th><th>Asset count</th></tr></thead><tbody>';
    chrono.forEach((r) => {
        h +=
            '<tr><td>' +
    ...
    h += '<div class="tbl-wrap"><table class="tbl"><thead><tr><th>Finished</th><th>Scan #</th><th>Total open</th>';
    sevKeys.forEach((k) => {
...
/** Apply enrichment checkbox state on the Scan tab (undefined = all enabled). */
function applyEnrichmentIdsToScanWrap(ids) {
    const wrap = document.getElementById('scan-enrichment-wrap');
    if (!wrap || wrap.dataset.ready !== '1') return;
    const boxes = wrap.querySelectorAll('input[data-enr-id]:not(:disabled)');
    ...
    const set = new Set(ids.map(id => parseInt(id, 10)));
    boxes.forEach(cb => {
        const id = parseInt(cb.dataset.enrId, 10);
        cb.checked = set.has(id);
    });
}

/** After a successful host rescan, mirror the job settings on the Scan tab (no extra preset overrides). */
function applyRescanChoiceToScanTab(choice, scanModeEffective) {
    ...
    const phasesSet = new Set(choice.phases || []);
    ['passive', 'icmp', 'banner', 'fingerprint', 'snmp', 'ot', 'cve'].forEach(p => {
        const el = document.getElementById('ph-' + p);
        if (el) el.checked = phasesSet.has(p);
    });
    const rp = Math.max(1, Math.min(50, parseInt(String(choice.rate_pps ?? '5'), 10) || 5));
    const rd = Math.max(0, Math.min(2000, parseInt(String(choice.inter_delay ?? '200'), 10) || 200));
    const ppsEl = document.getElementById('sc-pps');
    const delEl = document.getElementById('sc-delay');
    const ppsVal = document.getElementById('pps-val');
    const delVal = document.getElementById('delay-val');
    if (ppsEl) ppsEl.value = String(rp);
    if (ppsVal) ppsVal.textContent = rp + ' pps';
    if (delEl) delEl.value = String(rd);
    if (delVal) delVal.textContent = rd + ' ms';
    const mode = scanModeEffective || 'auto';
    const radioId = mode === 'routed' ? 'sm-routed' : mode === 'force' ? 'sm-force' : 'sm-auto';
    const rad = document.getElementById(radioId);
    ...
    const scEx = document.getElementById('sc-excl');
    if (scEx && choice.exclusions !== undefined) scEx.value = choice.exclusions;
...
function clampRescanScanModeForProfile(profile, scanMode) {
    const m = scanMode || 'auto';
    if (['iot_safe', 'ot_careful'].includes(profile) && m === 'force') {
        toast('Discovery mode set to Auto — this profile does not allow Force (-Pn).', 'ok');
        return 'auto';
    }
    return m;
...
function updateHostRescanProfileWarn(profile) {
    const w = document.getElementById('host-rescan-profile-warn');
    if (!w) return;
    if (SCHED_HIGH_IMPACT_PROFILES.includes(profile)) {
        w.style.display = 'block';
        const lines = {
...
async function openHostPanel(id, ip) {
    ...
    }).join('') : '<div class="hp-empty st-host-empty">No open ports on record. Run a scan to discover listening services.</div>';
    ...
    const serviceRows = serviceChips.length
        ...
        : `<div class="hp-empty st-host-empty">No service fingerprints yet. Banners and probes populate after discovery runs.</div>`;
    ...
    const findingRows = openFindings.length ? openFindings.map(f => `
        ...
        </div>`).join('') : '<div class="hp-empty st-host-empty">No open CVEs matched for this host. Rescan to refresh NVD correlation.</div>';
    ...
    const acceptedFindingRows = acceptedFindings.length ? acceptedFindings.map(f => `
        ...
        </div>`).join('') : '<div class="hp-empty st-host-empty">No accepted-risk CVEs on this host.</div>';
    ...
    const deviceLinkHtml = a.device_id != null && a.device_id !== ''
        ...
        : '—';
    const deviceSummaryHtml = a.device_id != null && a.device_id !== ''
        ? `<span class="click-ip" onclick="openDevicePanel(${a.device_id})" title="Open logical device overview">${esc(String(a.device_id))}</span>`
        : '<span class="text-dim">No linked device</span>';
    ...
    hpBody.innerHTML = `
      ...
      <section class="host-section st-host-overview-shell" aria-label="Overview">
        ...
        <div class="st-host-summary-strip">
          <div class="st-host-summary-item st-host-summary-item--emph"><span class="st-host-summary-k">Open CVEs</span><span class="st-host-summary-v">${esc(String(openFindings.length))}</span></div>
          <div class="st-host-summary-item st-host-summary-item--emph"><span class="st-host-summary-k">Lifecycle</span><span class="st-host-summary-v">${esc(lifecycleState)}</span></div>
        ...
        <section class="host-section st-host-subsection" aria-label="Identity and inventory">
          ...
          <table class="hp-meta-table">
            ...
            <tr class="st-host-meta-secondary"><td class="hp-meta-key">CPE</td><td class="hp-meta-val-dim cpe-break">${esc(a.cpe||'—')}</td></tr>
            <tr class="st-host-meta-secondary"><td class="hp-meta-key">IPv6</td><td class="hp-meta-val-dim cpe-break">${
              (a.ipv6_addrs || []).length ? esc((a.ipv6_addrs || []).join(', ')) : '—'
            }</td></tr>
            <tr class="st-host-meta-secondary"><td class="hp-meta-key">Connected via</td><td class="hp-meta-val-dim">${esc(a.connected_via||'—')}</td></tr>
            <tr class="st-host-meta-secondary"><td class="hp-meta-key">First seen</td><td class="hp-meta-val-dim">${localTime(a.first_seen)}</td></tr>
            <tr class="st-host-meta-secondary"><td class="hp-meta-key">Last seen</td><td class="hp-meta-val-dim">${relTime(a.last_seen)}</td></tr>
            <tr class="st-host-meta-secondary"><td class="hp-meta-key">Discovery</td><td class="hp-meta-val-dim">${discoverySources.length ? esc(discoverySources.join(', ')) : '—'}</td></tr>
            ${aiInfluenced ? '<tr class="st-host-meta-secondary"><td class="hp-meta-key">Classification</td><td class="hp-meta-val-dim">Local AI enrichment influenced category</td></tr>' : ''}
            ${a.ai_last_attempted ? `<tr class="st-host-meta-secondary"><td class="hp-meta-key">AI confidence</td><td class="hp-meta-val-dim">${a.ai_last_confidence != null ? esc(String(a.ai_last_confidence.toFixed ? a.ai_last_confidence.toFixed(2) : a.ai_last_confidence)) : '—'}</td></tr>` : ''}
            ${a.ai_last_attempted ? `<tr class="st-host-meta-secondary"><td class="hp-meta-key">AI suggestion</td><td class="hp-meta-val-dim">${esc(a.ai_last_suggested_category || '—')} ${a.ai_last_applied ? '(applied)' : '(not applied)'}</td></tr>` : ''}
            ${a.ai_last_rationale ? `<tr class="st-host-meta-secondary"><td class="hp-meta-key">AI rationale</td><td class="hp-meta-val-dim">${esc(a.ai_last_rationale)}</td></tr>` : ''}
            ${a.ai_last_reason ? `<tr class="st-host-meta-secondary"><td class="hp-meta-key">AI skip reason</td><td class="hp-meta-val-dim">${esc(a.ai_last_reason)}</td></tr>` : ''}
            ${a.notes ? `<tr class="st-host-meta-secondary"><td class="hp-meta-key">Notes</td><td class="hp-meta-val-dim">${esc(a.notes)}</td></tr>` : ''}
          </table>
          </div>
        </section>
      </section>
      ...
      <div class="mb8 host-inner-surface">${
        (assetData.asset.port_history||[]).slice(0,5).map(h => `
          ...
          </div>`).join('') || '<div class="hp-empty st-host-empty">No port change timeline yet.</div>'
      }</div>
      </section>
...
function exportAssets(format) {
    ...
    const aiRev = !!window.__stAiNeedsReviewFilterAvailable && !!document.getElementById('af-ai-review')?.checked;
