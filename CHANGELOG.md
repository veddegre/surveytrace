...
- **Documentation updates** — README roadmap cleanup with named tracks and clearer deferred connector notes; added `docs/CONNECTOR_DEVELOPMENT_GUIDE.md` and `docs/UI_CLEANUP_PLAN.md`.
