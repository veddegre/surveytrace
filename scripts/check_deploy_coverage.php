 ...
 * or under scripts_dev_only / daemon_dev_only_py (never shipped). See the manifest file header. For new
 * first-class api/*.php surfaces, also add matching post-verify checks in deploy.sh and setup.sh.
 *
 * Usage:
