...
check_file "$DEST/api/lib_software_inventory.php" "lib_software_inventory.php (normalized inventory read helpers)"
check_file "$DEST/api/software_inventory.php" "software_inventory.php API"
check_file "$DEST/api/lib_version_compare.php" "lib_version_compare.php (dpkg/rpm version ordering)"
check_file "$DEST/api/lib_vulnerability_advisory_import.php" "lib_vulnerability_advisory_import.php (advisory import helpers)"
check_file "$DEST/api/lib_vulnerability_correlation.php" "lib_vulnerability_correlation.php (advisory correlation)"
check_file "$DEST/api/lib_vulnerability_priority.php" "lib_vulnerability_priority.php (deterministic vuln prioritization)"
check_file "$DEST/api/lib_vulnerability_triage.php" "lib_vulnerability_triage.php (analyst triage + audit)"
check_file "$DEST/api/vulnerabilities.php" "vulnerabilities.php API"
check_file "$DEST/api/vulnerability_triage.php" "vulnerability_triage.php API (bounded triage workflow)"
check_file "$DEST/scripts/import_advisories.php" "import_advisories.php (bounded advisory JSON)"
...
check_file "$DEST/scripts/st_vulnerability_dashboard_selftest.php" "st_vulnerability_dashboard_selftest.php"
check_file "$DEST/api/vulnerability_dashboard.php" "vulnerability_dashboard API"
check_file "$DEST/scripts/run_operational_integrity_suite.php" "run_operational_integrity_suite.php"
check_file "$DEST/scripts/check_database_integrity.php" "check_database_integrity.php"
check_file "$DEST/scripts/st_operational_integrity_selftest.php" "st_operational_integrity_selftest.php"
check_file "$DEST/scripts/diagnose_operational_integrity.php" "diagnose_operational_integrity.php"
check_file "$DEST/scripts/st_vulnerability_remediation_selftest.php" "st_vulnerability_remediation_selftest.php"
check_file "$DEST/scripts/diagnose_vulnerability_remediation.php" "diagnose_vulnerability_remediation.php"
check_file "$DEST/scripts/prune_vulnerability_remediation_history.php" "prune_vulnerability_remediation_history.php"
check_file "$DEST/api/vulnerability_remediation.php" "vulnerability_remediation API"
...
check_file "$DEST/daemon/cred_ssh_probe_cli.py" "cred_ssh_probe_cli.py (SSH cred probe from server)"
...
check_file "$DEST/daemon/software_inventory_normalize.py" "software_inventory_normalize.py (package name/version normalization)"
check_file "$DEST/daemon/software_inventory_persist.py" "software_inventory_persist.py (cred inventory → SQLite)"
check_file "$DEST/daemon/vuln_correlation_jobs.py" "vuln_correlation_jobs.py (post-inventory correlation enqueue)"
...
check_file "$DEST/docs/samples/README.md" "docs/samples/README.md (advisory sample payloads)"
check_file "$DEST/docs/samples/nvd_metadata.sample.json" "docs/samples/nvd_metadata.sample.json"
check_file "$DEST/docs/samples/distro_advisories.sample.json" "docs/samples/distro_advisories.sample.json"
check_file "$DEST/docs/samples/ubuntu_production.sample.json" "docs/samples/ubuntu_production.sample.json"
check_file "$DEST/docs/samples/ubuntu_intermediate.sample.json" "docs/samples/ubuntu_intermediate.sample.json"
check_file "$DEST/docs/samples/ubuntu_oval_fragment.xml" "docs/samples/ubuntu_oval_fragment.xml"
check_file "$DEST/docs/samples/advisory_cve_test.sample.json" "docs/samples/advisory_cve_test.sample.json"
